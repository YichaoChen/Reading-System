...
<script>
    ...
    //             $("#content").animate({"padding":"0 0 0 300px"}, 500)
    ...
    //         }
    //         if (flag == 1) {
    //             $("#sidebar").animate({"width":"300px"}, 500).show()
    //             $("#slide-btn").animate({"left":"300px"}, 500)
    //             $("#content").animate({"padding":"0 0 0 300px"}, 500)
    ...
    $(document).ready(function () {
        ...
        $("#slide-btn").click(function () {
            ...
            if (flag == 2) {
                $("#sidebar").animate({"width":"300px"}, 500).show()
                $("#slide-btn").animate({"left":"300px"}, 500)
                $("#content").animate({"padding":"0 0 0 400px"}, 500)
                $("#toggle-question-status").show(500);
                flag = 0
                return true;
            }
...
<div id="container">
  <div id="sidebar">
  <iframe name="iframe-pt" id="iframe-partition-table" width="300px" height="100%" scrolling="no" style="overflow:hidden; float:right;" 
        src="partition-table.php?v=100&layout=0&usr=<?php echo $usr;?>&grp=<?php echo $grp;?>&sid=<?php echo $sid;?>&course=<?php echo $course;?>&dbase=<?php echo $course_kseadb;?>&docno=<?php echo $docno;?>" ></iframe>
  <!--<iframe name="iframe-pt" id="iframe-partition-table" width="100px" height="100%" scrolling="no" style="overflow:hidden; float:right;" 
        src="partition-table.php?v=100&layout=1&usr=<?php echo $usr;?>&grp=<?php echo $grp;?>&sid=<?php echo $sid;?>&course=<?php echo $course;?>&dbase=<?php echo $course_kseadb;?>&docno=<?php echo $docno;?>" ></iframe>
