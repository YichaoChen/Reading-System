...
$dbase = $_GET["dbase"];
$docno = "";
$layout = $_GET["layout"];//added by jordan
...
<head>
    ...
    <script type='text/javascript'>
        ...
        var layout = "<?php echo $layout;?>";//added by jordan
...
<body>
    ...
    <div id="partition-table-div">
        <span id="tip" style="position: absolute; left: 0; top: 0; width:20%; border-bottom: 1px solid #cccccc; font-size: 12px; line-height:16px;"></span>
        <!--<div id="detail">
...
<?php
    if ($layout==0){
?>
    <script id="ptid" type="text/javascript" src="partition-table.js?v=101"></script>
<?php
    }else{
?>
    <script id="ptid" type="text/javascript" src="partition-table-questions.js?v=101"></script>
<?php
}
?>
